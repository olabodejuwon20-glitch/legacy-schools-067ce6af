...
import { Inbox, MessageSquare, Hash, Megaphone, Radio, LifeBuoy, FileText, Clock, BarChart3, Bell, HeartHandshake, Menu } from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="h-[calc(100vh-3.5rem)] flex bg-background">
        {/* Mobile top bar */}
        <div className="md:hidden absolute top-[3.5rem] inset-x-0 z-20 flex items-center gap-2 border-b bg-card/80 backdrop-blur px-3 py-2">
          ...
          <span className="text-sm font-medium text-muted-foreground truncate">Communication</span>
        </div>

        <aside className="hidden md:block w-56 shrink-0 border-r bg-card/40 overflow-y-auto">
        ...
        <main className="flex-1 min-w-0 overflow-hidden pt-12 md:pt-0">
